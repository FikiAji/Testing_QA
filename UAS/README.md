...
https://github.com/FikiAji/TESTING_QA/blob/master/UAS/test/test_routes.py#L27-L50

dan untuk create factory ditambahkan jg data untuk model cart

https://github.com/FikiAji/TESTING_QA/blob/master/UAS/test/test_models.py#L35-L74
